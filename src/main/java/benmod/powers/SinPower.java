...
public class SinPower extends AbstractPower {
    public static final String POWER_ID = ModHelper.makePath("SinPower");
    ...
    public void atEndOfRound() {
        this.flash();
        if (this.amount == 0) {
            this.addToBot(new RemoveSpecificPowerAction(this.owner, this.owner, "BenMod:SinPower"));
        } else {
            this.addToBot(new ReducePowerAction(this.owner, this.owner, "BenMod:SinPower", 1));
        }
    }
