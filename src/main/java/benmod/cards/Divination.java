...
public class Divination extends CustomCard {
    public static final String ID = ModHelper.makePath("Divination");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new ApplyPowerAction(p, p, new DivinationPower(p, this.magicNumber), this.magicNumber));
    }
