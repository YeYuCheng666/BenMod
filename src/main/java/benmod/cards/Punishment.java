...
public class Punishment extends CustomCard {
    public static final String ID = ModHelper.makePath("Punishment");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new PunishmentAction(m, new DamageInfo(p, this.damage, this.damageTypeForTurn)));
    }
