...
import benmod.powers.GodTravelPower;
import benmod.powers.SpectralPower;
import benmod.powers.WantedPower;
...
public class GodTravel extends CustomCard {
    public static final String ID = ModHelper.makePath("GodTravel");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new ApplyPowerAction(p, p, new GodTravelPower(p, this.magicNumber), this.magicNumber));
    }
