...
import benmod.actions.DoubleForgivenessAction;
...
public class DeathBook extends CustomCard {
    public static final String ID = ModHelper.makePath("DeathBook");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new DoubleForgivenessAction(m, p));
    }
