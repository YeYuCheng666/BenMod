...
public class SoulFlying extends CustomCard {
    public static final String ID = ModHelper.makePath("SoulFlying");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        if (!p.hand.group.isEmpty()) {
            for(AbstractMonster mo : AbstractDungeon.getCurrRoom().monsters.monsters) {
                this.addToBot(new ApplyPowerAction(mo, p, new SinPower(mo, p.hand.group.size()), p.hand.group.size(), true, AbstractGameAction.AttackEffect.NONE));
            }
        }
    }

    public AbstractCard makeCopy() {
        return new SoulFlying();
    }
}
