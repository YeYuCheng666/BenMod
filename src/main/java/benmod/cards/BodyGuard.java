...
import benmod.powers.BodyGuardPower;
...
public class BodyGuard extends CustomCard {
    public static final String ID = ModHelper.makePath("BodyGuard");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new ApplyPowerAction(p, p, new BodyGuardPower(p, this.magicNumber), this.magicNumber));
    }
