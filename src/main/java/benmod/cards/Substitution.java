...
import benmod.actions.SubstitutionAction;
...
public class Substitution extends CustomCard {
    public static final String ID = ModHelper.makePath("Substitution");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new SubstitutionAction());
    }
