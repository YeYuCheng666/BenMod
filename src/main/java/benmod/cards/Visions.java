...
import benmod.actions.VisionsAction;
...
public class Visions extends CustomCard {
    public static final String ID = ModHelper.makePath("Visions");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new VisionsAction(p, this.energyOnUse, this.upgraded, this.freeToPlayOnce));
    }
