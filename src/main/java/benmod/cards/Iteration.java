...
import benmod.powers.IterationPower;
...
public class Iteration extends CustomCard {
    public static final String ID = ModHelper.makePath("Iteration");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new ApplyPowerAction(p, p, new IterationPower(p, 1), 1));
    }
