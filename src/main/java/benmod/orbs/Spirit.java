...
public class Spirit extends AbstractOrb {
    public static final String ORB_ID = "BenMod:Spirit";
    ...
    public Spirit() {
        this.ID = "BenMod:Spirit";
        this.img = new Texture("BenModResources/images/Orbs/Spirit.png");
...
//        this.applyFocus();
        this.description = DESC[0] + HPloss + DESC[1] + this.passiveAmount + DESC[2] + this.baseEvokeAmount + DESC[3];
    }
...
//        else
            AbstractDungeon.actionManager.addToTop(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, new FocusPower(AbstractDungeon.player, this.baseEvokeAmount), this.baseEvokeAmount));
    }
...
//        else
        AbstractDungeon.actionManager.addToBottom(new LoseHPAction(AbstractDungeon.player, AbstractDungeon.player, HPloss));
