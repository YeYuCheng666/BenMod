...
public class Cure extends AbstractOrb {
    public static final String ORB_ID = "BenMod:Cure";
    ...
    public Cure() {
        this.ID = "BenMod:Cure";
        this.img = new Texture("BenModResources/images/Orbs/Cure.png");
...
//        else
        AbstractDungeon.actionManager.addToTop(new HealAction(AbstractDungeon.player, AbstractDungeon.player, this.baseEvokeAmount));
    }
...
//        else
        AbstractDungeon.actionManager.addToBottom(new HealAction(AbstractDungeon.player, AbstractDungeon.player, this.basePassiveAmount));
    }
